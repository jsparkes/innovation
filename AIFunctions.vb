...
jeff: 
	...
	Public Function score_game_individual(ByVal player As Short) As Object
		...
		Dim num_at_max, j, i, max, top_card As Object
		Dim top_score As Short
